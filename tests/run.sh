...
quick=(test_qwen.js test_smollm.js test_stream.js test_batch.js test_reset.js test_qwen_split.js test_qwen_stream.js test_batch_split.js test_narrow.js test_tune_shapes.js)
