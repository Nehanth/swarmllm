// Run tests/bench/bench.html in Chrome with the real GPU. node tests/bench/chrome_bench.mjs <model path under repo> [tokens] [extra query, e.g. "specfuse=0&draftchain=0"]
