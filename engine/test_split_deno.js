...
import { parseSafetensors, makeTokenizer, BelloEngine, argmax } from "./engine.js";
...
const tensors = parseSafetensors((await Deno.readFile(dir + "model/model.safetensors")).buffer);
