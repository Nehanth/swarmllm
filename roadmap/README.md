...
| 12 | [Stop, fail fast, re-deal: the room survives launch day](12-room-survives-launch-day.md) | now | mostly landed (automatic re-deal on join open) · [#12](https://github.com/Nehanth/swarmllm/issues/12) |
| 13 | [Multi-turn conversation and an honest context limit](13-multi-turn-context.md) | now | landed (per-model maxSeq open) · [#13](https://github.com/Nehanth/swarmllm/issues/13) |
| 14 | [Pre-flight check, join links, and a model ladder that says what this room can run](14-preflight-and-join-links.md) | now | mostly landed (measured budget open) · [#14](https://github.com/Nehanth/swarmllm/issues/14) |
...
| 18 | [Download path: Hugging Face backoff and mirrors, parallel range streams, phone cache](18-download-path.md) | now | parallel fetch + peer-to-peer weights landed · [#18](https://github.com/Nehanth/swarmllm/issues/18) |
...
| 25 | [Cross-network quick wins: draft cache, frame chunking, prefill acks, per-hop telemetry](25-cross-network-quick-wins.md) | now | draft cache + telemetry landed; real-network numbers open · [#25](https://github.com/Nehanth/swarmllm/issues/25) |
...
| 27 | [Placement, chain order and host election](27-placement-and-chain-order.md) | next | speed-aware placement landed; chain order open · [#27](https://github.com/Nehanth/swarmllm/issues/27) |
